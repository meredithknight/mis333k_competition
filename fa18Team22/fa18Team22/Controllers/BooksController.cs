...
namespace fa18Team22.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookID,UniqueID,Title,Author,PublishDate,BookDetail,SalesPrice,Inventory,AvgRating,ReplenishMinimum")] Book book)
        {
