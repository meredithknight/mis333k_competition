...
namespace fa18Team22.Migrations
{
    ...
    [Migration("20181116193450_AppUserBookCost")]
    partial class AppUserBookCost
    {
            ...
            modelBuilder.Entity("fa18Team22.Models.Review", b =>
                {
                    ...
                    b.Property<string>("AppUserEmailAddress1");
                    ...
                    b.HasIndex("AppUserEmailAddress");

                    b.HasIndex("AppUserEmailAddress1");
            ...
            modelBuilder.Entity("fa18Team22.Models.Review", b =>
                {
                    b.HasOne("fa18Team22.Models.AppUser")
                        ...
                        .HasForeignKey("AppUserEmailAddress");

                    b.HasOne("fa18Team22.Models.AppUser")
                        .WithMany("ReviewsWritten")
                        .HasForeignKey("AppUserEmailAddress1");
